...
#ifndef __TGEMSBSGEMSimHitData__
#define __TGEMSBSGEMSimHitData__
...
class TGEMSBSGEMSimHitData 
{
 public:
  ...
  TGEMSBSGEMSimHitData (UInt_t h = 0);
  virtual ~TGEMSBSGEMSimHitData();
  ...
  //void AddGEMData(TGEMSBSGEMSimHitData* gd);
