...
//#include "TGEMSBSGeant4File.h"  // needed for g4sbsgendata class def
...
Int_t
TGEMSBSSimDigitization::AdditiveDigitize (const TGEMSBSGEMSimHitData& gdata, const TGEMSBSSpec& spect)
{
...
void
TGEMSBSSimDigitization::IonModel(const TVector3& xi,
				 const TVector3& xo,
...
#define DBG_AVA 0
  ...
  TGEMSBSGEMHit **virs;
  virs = new TGEMSBSGEMHit *[fNPlanes[ic]];
