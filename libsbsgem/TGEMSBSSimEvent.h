...
#ifndef __TGEMSBSSim_h
#define __TGEMSBSSim_h
...
//-----------------------------------------------------------------------------
class TGEMSBSSimTrack : public Podd::MCTrack {
public:
  TGEMSBSSimTrack( Int_t number, Int_t pid,
  ...
  // Now I'm wondering if TGEMSBSSimTrack is useful at all, but in case, we will stick to that
...
class TGEMSBSECalCluster : public TObject {
 public:
  TGEMSBSECalCluster(double E, double X, double Y, double t = 0);
  TGEMSBSECalCluster();
  ~TGEMSBSECalCluster(){};
...
class TGEMSBSSimEvent : public TObject {
public:
  TGEMSBSSimEvent();                 // Default constructor, for ROOT I/O
  TGEMSBSSimEvent( UInt_t ntracks ); // Construct and initialize fMCTracks
  virtual ~TGEMSBSSimEvent();

  virtual void Clear( Option_t* opt="" );
  virtual void Print( Option_t* opt="" ) const;
  TGEMSBSSimTrack* AddTrack( Int_t number, Int_t pid,
