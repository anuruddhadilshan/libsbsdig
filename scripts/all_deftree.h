...
// Thu May 12 14:42:25 2022 by ROOT version 6.24/06
// from TTree T/Geant4 SBS Simulation
// found on file: /volatile/halla/sbs/efuchey/kine0_20220503_16/wapp_0.root
//////////////////////////////////////////////////////////

#ifndef all_deftree_h
#define all_deftree_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   vector<int>     *Harm_RICH_hit_otridx;
   vector<int>     *Harm_RICH_hit_ptridx;
   vector<int>     *Harm_RICH_hit_sdtridx;
   ...
   TBranch        *b_Harm_RICH_hit_otridx;   //!
   TBranch        *b_Harm_RICH_hit_ptridx;   //!
   TBranch        *b_Harm_RICH_hit_sdtridx;   //!
...
#ifdef all_deftree_cxx
all_deftree::all_deftree(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/volatile/halla/sbs/efuchey/kine0_20220503_16/wapp_0.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/volatile/halla/sbs/efuchey/kine0_20220503_16/wapp_0.root");
      }
      f->GetObject("T",tree);
...
all_deftree::~all_deftree()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t all_deftree::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t all_deftree::LoadTree(Long64_t entry)
{
...
void all_deftree::Init(TTree *tree)
{
   ...
   Harm_RICH_hit_otridx = 0;
   Harm_RICH_hit_ptridx = 0;
   Harm_RICH_hit_sdtridx = 0;
   ...
   fChain->SetBranchAddress("Harm.RICH.hit.otridx", &Harm_RICH_hit_otridx, &b_Harm_RICH_hit_otridx);
   fChain->SetBranchAddress("Harm.RICH.hit.ptridx", &Harm_RICH_hit_ptridx, &b_Harm_RICH_hit_ptridx);
   fChain->SetBranchAddress("Harm.RICH.hit.sdtridx", &Harm_RICH_hit_sdtridx, &b_Harm_RICH_hit_sdtridx);
...
void all_deftree::Show(Long64_t entry)
{
...
Int_t all_deftree::Cut(Long64_t entry)
{
