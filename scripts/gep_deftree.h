...
// Wed Oct 25 14:53:23 2023 by ROOT version 6.26/10
// from TTree T/Geant4 SBS Simulation
// found on file: /volatile/halla/sbs/efuchey/gep1_beambkgd_20231025/GEP1_beambkgd_job_0.root
//////////////////////////////////////////////////////////

#ifndef gep_deftree_h
#define gep_deftree_h
...
#ifdef gep_deftree_cxx
gep_deftree::gep_deftree(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/volatile/halla/sbs/efuchey/gep1_beambkgd_20231025/GEP1_beambkgd_job_0.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/volatile/halla/sbs/efuchey/gep1_beambkgd_20231025/GEP1_beambkgd_job_0.root");
      }
      f->GetObject("T",tree);
...
gep_deftree::~gep_deftree()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t gep_deftree::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t gep_deftree::LoadTree(Long64_t entry)
{
...
void gep_deftree::Init(TTree *tree)
{
...
void gep_deftree::Show(Long64_t entry)
{
...
Int_t gep_deftree::Cut(Long64_t entry)
{
