...
// Fri May 29 18:31:58 2020 by ROOT version 6.14/04
// from TTree T/Geant4 SBS Simulation
// found on file: /volatile/halla/sbs/efuchey/gentpe4.5_inelastic_20200529_11/inelastic_0.root
//////////////////////////////////////////////////////////

#ifndef gmn_deftree_h
#define gmn_deftree_h
...
#ifdef gmn_deftree_cxx
gmn_deftree::gmn_deftree(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/volatile/halla/sbs/efuchey/gentpe4.5_inelastic_20200529_11/inelastic_0.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/volatile/halla/sbs/efuchey/gentpe4.5_inelastic_20200529_11/inelastic_0.root");
      }
      f->GetObject("T",tree);
...
gmn_deftree::~gmn_deftree()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t gmn_deftree::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t gmn_deftree::LoadTree(Long64_t entry)
{
...
void gmn_deftree::Init(TTree *tree)
{
...
void gmn_deftree::Show(Long64_t entry)
{
...
Int_t gmn_deftree::Cut(Long64_t entry)
{
